...
const Login = () => {
  ...
  const [loginData, setLoginData] = useState({
    email: 'admin@gympro.com', // Pre-fill for testing
  ...
  const handleRegister = async (e) => {
    ...
    // For now, let's just show a message since registration creates regular users
    setMessage('Registration creates regular user accounts. Only admin accounts can access the dashboard.');
    setLoading(false);
  };
        ...
        {isLogin ? (
          ...
          <form onSubmit={handleRegister} className="auth-form">
            ...
            <div className="demo-credentials">
              ...
              <p>Registration creates regular user accounts.</p>
